use application::services::users::cqe::RegisterUserCommand;
use domain::users::{
    requests::{LoginUserDto, LoginUserRequest, RegisterUserDto},
...
pub async fn register_user(username: String, email: String, password: String) -> AuthenticationResult {
    ...
    let response = post::<UserAuthenicationResponse, RegisterUserCommand>(
        *AUTH_ENDPOINT,
        RegisterUserCommand {
