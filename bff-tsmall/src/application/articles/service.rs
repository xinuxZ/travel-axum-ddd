...
use crate::domain::articles::{DynArticlesRepository, GetArticleQuery};
use crate::domain::articles::ArticlesService;
use crate::domain::tags::DynTagsRepository;
use crate::infrastructure::errors::{AppError, AppResult};

use super::cqe::GetArticlesQuery;
use super::dto::ArticleDto;

pub struct AppArticlesService {
    articles_repository: DynArticlesRepository,
    tags_repository: DynTagsRepository,
}

impl AppArticlesService {
...
#[async_trait]
impl ArticlesService for AppArticlesService {
    ...
    async fn create_article(
        ...
        if article_title_exists {
            return Err(AppError::ObjectConflict(String::from("article with that title exists")));
        }
    ...
    async fn update_article(
        ...
        if let Some(new_title) = title {
            ...
            if article_with_updated_slug_exists {
                return Err(AppError::ObjectConflict(String::from(
        ...
        Err(AppError::NotFound(String::from("article not found")))
    }
    ...
    async fn delete_article(&self, user_id: i64, slug: String) -> AppResult<()> {
        ...
        Err(AppError::NotFound(String::from("article was not found")))
    }
...
impl AppArticlesService {
    async fn map_to_articles(&self, articles: Vec<GetArticleQuery>) -> AppResult<Vec<ArticleDto>> {
