...
/// around which themselves depend on the supplier repostiory, and ultimately, our Posgres connection pool.
...
pub trait SuppliersService {
    ...
    // async fn updated_supplier(&self, supplier_id: i64, request: UpdateSupplierCommand) -> AppResult<SupplierDto>;
}
